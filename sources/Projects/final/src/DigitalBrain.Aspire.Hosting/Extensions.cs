    ...
    public static class Extensions
    {
        ...
        public static ISiloBuilder UseDigitalBrain(this ISiloBuilder silo, DigitalBrain.Aspire.Hosting.DigitalBrainSiloOptions? options = null)
        {
            ...
            silo.Configure<EndpointOptions>(o =>
            {
                ...
                o.SiloListeningEndpoint = new System.Net.IPEndPoint(advertised, siloPort);
                o.GatewayListeningEndpoint = new System.Net.IPEndPoint(advertised, gatewayPort);
            });
        ...
        public static IHostApplicationBuilder AddDigitalBrainLlms(this IHostApplicationBuilder builder)
        {
            ...
            var fastModel = Environment.GetEnvironmentVariable("DIGITALBRAIN_LLM_FAST") ?? Environment.GetEnvironmentVariable("GEMMA_MODEL") ?? "gemma3:1b";
            ...
            builder.Services.AddSingleton(sp => sp.GetRequiredKeyedService<IChatClient>("fast"));
