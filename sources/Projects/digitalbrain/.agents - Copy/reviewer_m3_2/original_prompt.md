...
**Output Requirements**:
Write a structured handoff report in your working directory `e:/digitalbrain/.agents/reviewer_m3_2` outlining your assessment, verification results, and any findings.
