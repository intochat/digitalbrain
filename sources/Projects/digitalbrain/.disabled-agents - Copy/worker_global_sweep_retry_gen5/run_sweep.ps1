...
$logDir = Join-Path $workspace ".agents\worker_global_sweep_retry_gen5\logs"
...
"@
        Set-Content -Path (Join-Path $workspace ".agents\worker_global_sweep_retry_gen5\progress.md") -Value $progressContent
...
Set-Content -Path (Join-Path $workspace ".agents\worker_global_sweep_retry_gen5\sweep_results.json") -Value $resultsJson
