...
public static class IAWSiloExtensions
{
    ...
    {
        // OTel + health checks + service discovery are owned by ino's
        // ServiceDefaultsExtensions.AddServiceDefaults() — every ino silo calls it
        // before AddIAW(). Don't re-register here or DefaultHealthCheckService throws
        // on duplicate "self" liveness probes.
