...
/// Simple counter that accumulates values with dimensional attributes.
class SimpleCounter {
  SimpleCounter({
    required this.name,
    this.unit = '',
  ...
  final Map<String, int> _points = {}; // key = sorted attrs → cumulative sum
...
/// Simple histogram that records values and computes count/sum.
...
/// Periodically exports counters and histograms as OTLP/HTTP JSON.
class OtlpMetricExporter {
  ...
  Future<void> flush() async {
    ...
    try {
      ...
      // telemetry export failures are silent
    }
  }
