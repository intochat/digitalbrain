...
/// Severity numbers per OpenTelemetry spec
enum Severity {
  trace(1, 'TRACE'),
  debug(5, 'DEBUG'),
  info(9, 'INFO'),
...
/// Buffers log records and exports them as OTLP/HTTP JSON to an endpoint.
class OtlpLogExporter {
  ...
  Future<void> flush() async {
    ...
    try {
      ...
      // telemetry export failures are silent — never crash the app
    }
  }
...
/// Convenience logger that wraps OtlpLogExporter.
class OtlpLogger {
