...
public class TripAdvisorDomainRepository(TripRadarDbContext dbContext)
    : Repository<TripAdvisorDomain>(dbContext), ITripAdvisorDomainRepository
{
    public async Task<TripAdvisorDomain?> GetByDomainNameAsync(string domainName,
        CancellationToken cancellationToken = default)
    {
        ...
        return await dbContext.TripAdvisorDomains
            .FirstOrDefaultAsync(
