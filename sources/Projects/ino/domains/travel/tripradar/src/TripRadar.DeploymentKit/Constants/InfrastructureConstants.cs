...
using TripRadar.DeploymentKit.Extensions;

namespace TripRadar.DeploymentKit.Constants;
...
public static class InfrastructureConstants
{
    ...
    public static class Defaults
    {
        ...
        public const string DefaultPassword = "DefaultPassword123!";
    }
    ...
    {
        public const string StartingDeployment = "Starting TripRadar infrastructure deployment...";
        ...
        public const string DeploymentCompleted = "Successfully completed TripRadar infrastructure deployment";
    }
