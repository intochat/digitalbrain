...
public static class ServiceConstants
{
    ...
    public static class EnvironmentVariables
    {
        ...
        public const string PostgresConnectionString = "ConnectionStrings__AppDb";
    ...
    public static class TestDefaults
    {
        ...
        public const string ConnectionString = "Server=localhost;Database=AppDb;Integrated Security=true;";
