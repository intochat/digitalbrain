using TripRadar.DeploymentKit.HealthChecks;
using TripRadar.DeploymentKit.Infrastructure;
...
using TripRadar.DeploymentKit.Validators;

namespace TripRadar.DeploymentKit.Extensions;

/// <summary>
/// Extension methods for configuring TripRadar deployment services.
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Adds the core Pulumi deployment services used by TripRadar deployment flows.
    /// </summary>
    ...
    /// <summary>
    /// Adds TripRadar deployment services to the service collection.
    /// </summary>
    /// <param name="services">The service collection to configure</param>
    /// <returns>The configured service collection for method chaining</returns>
    ...
    /// <summary>
    /// Adds TripRadar deployment services with custom configuration.
    /// </summary>
    /// <param name="services">The service collection to configure</param>
        ...
        Action<InfrastructureServiceOptions> configureOptions)
    {
        ...
        services.AddPulumiDeploymentCore(coreOptions =>
        {
            ...
            coreOptions.HttpClientName = options.HttpClientName ?? "TripRadarDeployment";
    ...
    /// <summary>
    /// Adds TripRadar deployment services with custom logging configuration.
    /// </summary>
