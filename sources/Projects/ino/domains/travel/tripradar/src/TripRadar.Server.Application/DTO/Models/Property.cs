...
public class Property
{
    ...
    [JsonPropertyName("deal_description")]
    public string? DealDescription { get; set; }

    [JsonPropertyName("nearby_places")]
    public List<NearbyPlace>? NearbyPlaces { get; set; }

    [JsonPropertyName("hotel_class")]
    ...
    [JsonPropertyName("location_rating")]
    ...
    [JsonPropertyName("essential_info")]
    public List<string>? EssentialInfo { get; set; }

    [JsonPropertyName("eco_certified")]
