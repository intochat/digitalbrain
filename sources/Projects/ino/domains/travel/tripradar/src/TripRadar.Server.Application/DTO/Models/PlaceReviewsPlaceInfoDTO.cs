...
public class PlaceReviewsPlaceInfoDTO
{
    ...
    public PlaceReviewsOperatingHoursDTO? OperatingHours { get; set; }
    ...
    public PlaceReviewsEditorialSummaryDTO? EditorialSummary { get; set; }

    [JsonPropertyName("user_review")]
    public PlaceReviewsUserReviewDTO? UserReview { get; set; }
}
