...
public sealed class BestFlightOption
{
    [JsonPropertyName("flights")]
    public List<FlightSegment> Flights { get; set; } = null!;

    [JsonPropertyName("layovers")]
    public List<Layover> Layovers { get; set; } = null!;

    [JsonPropertyName("total_duration")]
    public int TotalDuration { get; set; }

    [JsonPropertyName("carbon_emissions")]
    public CarbonEmissions CarbonEmissions { get; set; } = null!;
