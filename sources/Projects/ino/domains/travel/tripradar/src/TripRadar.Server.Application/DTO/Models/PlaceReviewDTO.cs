...
public class PlaceReviewDTO
{
    ...
    public PlaceReviewsUserDTO? User { get; set; }
    ...
    [JsonPropertyName("local_guide")]
    public bool? LocalGuide { get; set; }

    [JsonPropertyName("details")]
    public PlaceReviewsDetailsDTO? Details { get; set; }

    [JsonPropertyName("response")]
    public PlaceReviewsOwnerResponseDTO? Response { get; set; }
