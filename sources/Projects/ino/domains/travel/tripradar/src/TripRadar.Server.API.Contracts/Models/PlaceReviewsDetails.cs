...
public class PlaceReviewsDetails
{
    [JsonPropertyName("service")] public object? Service { get; set; } // Can be int or string
    ...
    [JsonPropertyName("food")] public object? Food { get; set; } // Can be int or string

    [JsonPropertyName("atmosphere")] public object? Atmosphere { get; set; } // Can be int or string
