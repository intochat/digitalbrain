...
public sealed class E2ETestBuilder
{
        ...
        where TModule : class, IModule, new()
    {
        ...
        _composition.WithModule<TModule>(module =>
        {
            if (new TModule() is IModuleE2EDefaults<TModule> defaults) { defaults.ConfigureE2E(module); }
    ...
    internal BrainComposition BuildComposition()
    {
        ...
        { throw new NotSupportedException("E2E tests run in another process. Select a compiled provider or a hosted endpoint fixture."); }
        return composition;
    }
