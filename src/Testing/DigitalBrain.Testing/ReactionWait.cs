...
public static class ReactionWait
{
    public static async Task<SignalDelivery> ForSignalAsync(INeuron neuron, string type, CancellationToken cancellationToken)
    {
    ...
    public static async Task UntilAsync(Func<Task<bool>> completed, CancellationToken cancellationToken = default)
    {
