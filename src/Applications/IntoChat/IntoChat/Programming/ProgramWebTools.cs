...
[McpServerToolType]
public sealed class ProgramWebTools(PlaywrightWebAgent web)
{
    ...
    [McpServerTool(Name = "browse_web"), Description("Use a Playwright web agent to read public pages, follow links and extract structured data for a task. Optional startUrl. Returns JSON and actual visited source URLs. No logins or form submissions. Programs use agent mode:web with prompt and optional startUrl.")]
