...
{
    public static readonly string[] Names = ["code_contracts", "code_draft_read", "code_draft_save", "code_draft_check", "code_check_read", "code_check_cancel", "behavior_read", "behavior_deploy", "behavior_start", "behavior_stop", "behavior_rollback", "behavior_logs", "behavior_describe", "behavior_details", "create_coding_run"];
