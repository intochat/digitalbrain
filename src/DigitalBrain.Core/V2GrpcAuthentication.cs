...
public static class V2GrpcAuthentication
{
    ...
    public static bool TryAuthenticate(IReadOnlyDictionary<string, string> metadata, V2SessionTokenService tokens, string expectedAudience, out RequestContext context, out DateTimeOffset expiresAt)
    {
        context = default!;
        expiresAt = default;
