...
// The composition a test declares (§8/§11): the explicit module neuron types the catalog
// is built over, plus the service instances their primary constructors resolve. Sealed
// after the fixture reads it; the fingerprint is what pins one Compose-declaring type to
// one composition forever.
