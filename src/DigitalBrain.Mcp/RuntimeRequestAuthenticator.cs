...
public sealed class RuntimeRequestAuthenticator(RuntimeSessionAuthority sessions, UiExternalIdentityAuthenticator externalIdentity)
{
    ...
    public async Task<RuntimeRequestContext?> AuthenticateMcpAsync(HttpContext httpContext, CancellationToken cancellationToken = default)
    {
        ...
        return external.Status == UiExternalAuthenticationStatus.Authenticated ? external.Context : null;
    }
}
