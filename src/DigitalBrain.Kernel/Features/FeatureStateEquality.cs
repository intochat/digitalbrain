...
internal static class FeatureStateEquality
{
    ...
    private static bool Same(
        IReadOnlyList<FeatureReleaseMetadata> left,
        IReadOnlyList<FeatureReleaseMetadata> right) =>
    ...
    private static bool Same(
        IReadOnlyList<FeatureApprovalState> left,
        IReadOnlyList<FeatureApprovalState> right) =>
        left.Count == right.Count && left.Zip(right).All(pair =>
    ...
    private static bool Same(
        IReadOnlyList<FeatureInstallationAuthorityState> left,
        IReadOnlyList<FeatureInstallationAuthorityState> right) =>
        left.Count == right.Count && left.Zip(right).All(pair =>
            pair.First.InstallationId == pair.Second.InstallationId &&
