...
/// reports picks. Pair it with `UiGraphNavigator` for visible navigation.
final class UiGraphView extends StatefulWidget {
  const UiGraphView({
    super.key,
  ...
  @override
  State<UiGraphView> createState() => _UiGraphViewState();
}

class _UiGraphViewState extends State<UiGraphView>
  ...
  @override
  void didUpdateWidget(covariant UiGraphView oldWidget) {
    ...
    for (final node in controller.nodes) {
      ...
      final painter = TextPainter(
        text: TextSpan(
          ...
          style: (module ? UiType.metaStrong : UiType.meta).copyWith(
