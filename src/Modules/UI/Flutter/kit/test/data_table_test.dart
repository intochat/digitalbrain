...
void main() {
  testWidgets('table fills editor width and uses compact rows', (tester) async {
    ...
    final controller = KitTableController(snapshot: sample());
      ...
      MaterialApp(
        ...
        home: Scaffold(
          body: SingleChildScrollView(
            child: KitDataTable(controller: controller),
          ),
        ),
      ),
    );
  ...
  testWidgets('long column names fit a narrow screen filter dialog', (
    ...
    final controller = KitTableController(
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(body: KitDataTable(controller: controller)),
        ),
      );
  ...
  test('stale tool snapshots cannot overwrite newer shared state', () {
    final controller = KitTableController(snapshot: sample(revision: 7));
