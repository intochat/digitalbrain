...
internal sealed class BlobUiImageStore(BlobServiceClient blobs) : IUiImageStore
{
    // Existing durable blob location; renaming source types must not orphan images.
