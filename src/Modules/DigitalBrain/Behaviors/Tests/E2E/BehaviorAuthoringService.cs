...
// Test-host orchestration for the programmable-behavior E2E. The product no longer exposes a
// behavior-authoring endpoint (P1.2); this keeps the lifecycle coverage without shipping /author.
