...
public sealed class BehaviorTools(BehaviorService programs, IBehaviorIntentCompiler? compiler = null)
{
    ...
    public string Examples() => Guard(() => JsonSerializer.Serialize(BehaviorExamples.All, Json));
    ...
    private static BehaviorDefinition Parse(string definition) => JsonSerializer.Deserialize<BehaviorDefinition>(definition, Json)
