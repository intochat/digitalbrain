...
public sealed class VideoHttpFacts
{
    ...
    public async Task GetMatchesLoad()
    {
        ...
        var state = await brain.HttpClient.GetFromJsonAsync<VideoState>("/workspaces/workspace-a/ui/videos/intro", new JsonSerializerOptions { PropertyNameCaseInsensitive = true }, ct);
