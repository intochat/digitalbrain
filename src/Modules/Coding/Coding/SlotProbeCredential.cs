...
// credential or read 401 forever. The keys are spelled out rather than referenced because the gate lives
// in the host, which references this module and not the other way round.
internal static class SlotProbeCredential
{
    public const string UsernameKey = "DigitalBrain:Auth:Username";
    public const string PasswordKey = "DigitalBrain:Auth:Password";
