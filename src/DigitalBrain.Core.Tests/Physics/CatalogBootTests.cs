...
namespace CollisionLeft
{
    ...
    public sealed class Probe : DigitalBrain.Neuron, DigitalBrain.INeuron<DigitalBrain.Core.Tests.Support.PlanDay>
    {
        public Task HandleAsync(DigitalBrain.Core.Tests.Support.PlanDay fact, CancellationToken cancellationToken)
            => Task.CompletedTask;
    }
}
