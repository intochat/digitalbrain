...
public sealed class ChatStreamEndpoint(UiEdgeFixture fixture)
{
    ...
    public async Task StreamEndpointYieldsDeltasAndJournalsOneAnswer()
    {
        ...
        Assert.Collection(
            ...
            fact => Assert.Equal(UiEdgeAssistantProbe.Answer, Assert.IsType<AssistantResponded>(fact.Synapse).Text));
    }
