...
public class AzureBlobIntegrationConfigBackingStoreTests
{
    ...
    public async Task MigrateLegacyEntryAsync_MissingKnownSourceDoesNotCreateAnEntry()
    {
        ...
        Assert.Equal(IntegrationConfigLegacyMigrationResult.SourceMissing, result);
    ...
    private static AzureBlobIntegrationConfigBackingStore Store(
