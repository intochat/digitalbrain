...
public abstract class WhisperModel
{
    ...
    // Explicit catalog — Assembly.GetTypes() loads FoundryLocalTranscriptionService and
    // then Microsoft.AI.Foundry.Local, which AppHost must not pull (PrivateAssets + RID).
