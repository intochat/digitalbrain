    ...
    : IHostedService
{
    ...
    private sealed record GoogleAppConfig(string? ClientId, string? ClientSecret, string? RedirectUri)
    {
        ...
        public static GoogleAppConfig From(IConfiguration configuration) => new(configuration["DigitalBrain:Google:ClientId"], configuration["DigitalBrain:Google:ClientSecret"], configuration["DigitalBrain:Google:RedirectUri"]);
