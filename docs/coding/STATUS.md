...
| Current task | Task 2: contracts and the JSON context (in progress); Task 1 complete |
| Last green gate | Task 1 commit `11310c38`: format + build (0 warnings) + `dotnet test DigitalBrain.slnx` 297 passed, 4 Docker skips (2026-09-13) |
| Last commit | `11310c38` coding: scaffold the Coding module with Roslyn packages |
| Open PRs | none |
...
|---|---|---|---|
| 0 workspace and map | `feature/coding-phase0-workspace` | in progress (task 2 of 9) | — |
