...
P1.3 | e465be0 | delta: -~1k (911+106, total 61696) | Rewired main.dart (removed SURFACE_DEMO import + if, now always router/RuntimeShell /chat); deleted app/lib/features/surface_demo/ and app/test/features/; build+flutter+test green; no 'surface_demo' string in app/. Accept met. P1.3 commit e465be0.
