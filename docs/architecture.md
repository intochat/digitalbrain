...
| Explicit surface | `WithUiEdge(Action<FlutterUiEdgeOptions>? = null)` and `WithFlutterHost(Action<FlutterHostOptions>? = null)` | Host options invented outside module builder |
