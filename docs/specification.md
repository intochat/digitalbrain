...
| L0 | `tests/DigitalBrain.Behaviors.Tests` | Behavior SDK program/context/manifest/identity contracts and deterministic canonical artifacts; not compiler, broker, worker, or installed execution |
...
| L2 | `tests/DigitalBrain.HostTests` | In-process fixture exclusivity for TestingAppHost and Quickstart AppHost; executable health proof only for the TestingAppHost silo `/health` |
