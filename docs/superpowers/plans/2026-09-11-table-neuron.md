...
## Task 2: Flutter kit and chat integration

- [x] Add wire models and authenticated client table methods in core; add reusable KitDataTable with filter dialog, typed inputs, sort headers, chips/removal/reset, column visibility, paging, row counts, loading and error handling.
...
- Flutter: core 27, kit 9, shell 17 tests passed; analyzer clean; release web build succeeded. Existing CupertinoIcons font warning remains.
