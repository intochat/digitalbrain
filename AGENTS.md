# AGENTS.md — DigitalBrain / NeuroOS Way of Working
...
- **Delete trash aggressively** (docs, dead code, plans). 99% of historical plans/specs are noise — kill them. Keep only living README.md + this AGENTS.md.
...
- **Self-evolution meta for WoW**: Use Ino/rail to propose improvements to AGENTS.md, .mcp.json, or this WoW (e.g. "propose new optimization"). Stage via proposal, get approved, apply. The process improves itself.
...
- **Strict delete-first + clean docs**: This AGENTS.md + README are the *only* living docs. All plan/*.md, archive, superpowers, old specs = trash. Deleting them reduces reading waste and decision fatigue (Step 2 of algorithm).
