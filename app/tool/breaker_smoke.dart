...
void main() {
  ...
  if (breaker.recordFailure()) {
    throw StateError('disabled after 1 failure post-reset');
  }
  if (breaker.recordFailure()) {
    throw StateError('disabled after 2 failures post-reset');
  }
  ...
  if (!breaker.disabled) {
    throw StateError(
      'trip must be permanent: breaker re-enabled after recordSuccess',
    );
  }
