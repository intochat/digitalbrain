...
void main() {
  testWidgets('Tabs fires ExperienceStep with the tapped item eventName', (
    tester,
  ) async {
    ...
    await tester.pumpWidget(
      _host(
        UiKitTabs(
          ...
          experienceId: 'p',
          items: const [
            {'label': 'One', 'eventName': 'one'},
            {'label': 'Two', 'eventName': 'two'},
          ],
  ...
  testWidgets(
    'Breadcrumb fires ExperienceStep with the tapped item eventName',
    (tester) async {
      Map<String, Object?>? captured;
      await tester.pumpWidget(
        _host(
          UiKitBreadcrumb(
            ...
            experienceId: 'p',
            items: const [
              {'label': 'Home', 'eventName': 'home'},
              {'label': 'Sub', 'eventName': 'sub'},
            ],
            onEvent: (n, a) => captured = a,
          ),
        ),
  ...
  testWidgets(
    'Pagination fires ExperienceStep with the tapped page eventName',
    (tester) async {
      Map<String, Object?>? captured;
      await tester.pumpWidget(
        _host(
          UiKitPagination(
            ...
            experienceId: 'p',
            items: const [
              {'label': '1', 'eventName': 'page-0'},
              {'label': '2', 'eventName': 'page-1'},
              {'label': '3', 'eventName': 'page-2'},
            ],
            onEvent: (n, a) => captured = a,
          ),
        ),
